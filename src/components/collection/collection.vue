  ...
  <div class="module module--padded collection">
    <div class="row collection-header">
      <div class="col-1-of-1">
        <router-link
          :to="'/user/' + collection.author._id"
          tag="div"
          class="collection-header__img"
        >
          <img
            sizes="5rem"
            :srcset="'/static/pics/' + collection.author._id + '/xs 100w, /static/pics/' + collection.author._id + '/sm 300w, /static/pics/' + collection.author._id + '/md 500w, /static/pics/' + collection.author._id + '/lg 800w, /static/pics/' + collection.author._id + '/xlg 1200w'"
    ...
    <div class="list">
      <p
        class="list__element"
        v-if="collection.documents.length === 0"
      >Nessun documento nella collezione.</p>
      <router-link
        class="list__element"
        v-for="(document, index) in collection.documents"
        :key="index"
        :to="'/static/documents/' + document._id"
        tag="a"
        target="_blank"
      >
        <span class="crop">
